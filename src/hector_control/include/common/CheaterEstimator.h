...
class CheaterRobotStateEstimator: public GenericEstimator{
    public:
        virtual void run()
        {
            this->_stateEstimatorData.result->orientation[0] = this->_stateEstimatorData.lowState->imus[0].quaternion[0];
            this->_stateEstimatorData.result->orientation[1] = this->_stateEstimatorData.lowState->imus[0].quaternion[1];
            this->_stateEstimatorData.result->orientation[2] = this->_stateEstimatorData.lowState->imus[0].quaternion[2];
            this->_stateEstimatorData.result->orientation[3] = this->_stateEstimatorData.lowState->imus[0].quaternion[3];
            ...
            this->_stateEstimatorData.result->omegaWorld[0] = this->_stateEstimatorData.lowState->imus[0].gyroscope[0];
            this->_stateEstimatorData.result->omegaWorld[1] = this->_stateEstimatorData.lowState->imus[0].gyroscope[1];
            this->_stateEstimatorData.result->omegaWorld[2] = this->_stateEstimatorData.lowState->imus[0].gyroscope[2];
            ...
            this->_stateEstimatorData.result->vWorld[0] = this->_stateEstimatorData.lowState->velocity[0];
            this->_stateEstimatorData.result->vWorld[1] = this->_stateEstimatorData.lowState->velocity[1];
            this->_stateEstimatorData.result->vWorld[2] = this->_stateEstimatorData.lowState->velocity[2];
